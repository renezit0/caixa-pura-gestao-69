...
const sidebarItems = [
  ...
  { title: 'Relatórios', url: '/relatorios', icon: History },
...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={cn(
        'fixed top-0 left-0 z-50 h-full w-64 bg-card border-r border-border transition-transform duration-300 lg:translate-x-0 lg:z-auto flex-shrink-0',
            ...
            {sidebarItems.map((item) => {
              ...
              return (
                <NavLink
                  ...
                  onClick={onClose}
                  className={cn(
                    'flex items-center space-x-3 px-3 py-3 rounded-lg transition-smooth group',
                    isActive 
